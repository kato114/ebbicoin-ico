				...
				<td style="padding:0;">
					<table style="font-family: sans-serif;" width="100%">
						<tr>
							...
							<p style="color:#fff;margin: 20px 0;font-size:16px ; font-family: sans-serif;">We received a request for reset password for your account on EbbiCoin. If you asked then click on reset password button to reset your password otherwise skip this mail.</p>
							<a href="<?=base_url('user/reset/'.$token)?>" style="background-color:#333; color:#c8a53e; padding:10px; border-radius:3px; box-shadow: 0 2px 5px 0 rgba(0,0,0,.16), 0 2px 10px 0 rgba(0,0,0,.12); width:100px; text-decoration:none; margin:20px 0; display:block; text-align:center; font-size:18px;">Verify</a>
							...
							<p><a href="<?=base_url('user/reset/'.$token)?>"><?=base_url('user/reset/'.$token)?></a></p>
