 ...
 <table align="center"  cellpadding="0" cellspacing="0" width="100%"style="max-width:600px;border: 1px solid #eee;box-shadow: 0 2px 5px 0 rgba(0,0,0,.16), 0 2px 10px 0 rgba(0,0,0,.12);">
                ...
                <table style="font-family: sans-serif;" width="100%">	
                	...
                	<tr>
                         <td width="100%" style="background-color: #000;color: #fff;padding: 0 15px; border-top: 3px solid #fff;">
                            ...
                            <p style="color:#fff;margin: 20px 0;font-size:16px ; font-family: sans-serif;">Thank you for submitting your support ticket to <b>EbbiCoin</b>. We will do our best to respond within 48 hours.</p>                            
        ...
        <tr  bgcolor="" >
        	<td>
            	<table style="font-family: sans-serif; "  width="100%">
                	<tr>
                    	<td style="color:#eee ;background-color:#000;"><p style="margin:0;font-size:12px;padding:10px 0;text-align:center;">&copy; Copyright 2021 EbbiCoin.com All Rights Reserved</p></td>
                    </tr>
                </table>
            </td>
		</tr> 	
